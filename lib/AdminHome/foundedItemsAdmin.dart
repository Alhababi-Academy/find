...
class foundedItems extends StatefulWidget {
  const foundedItems({super.key});

  @override
  State<foundedItems> createState() => _foundedItemsState();
}

class _foundedItemsState extends State<foundedItems> {
  @override
