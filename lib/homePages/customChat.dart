...
class customChat extends StatefulWidget {
  ...
  customChat({Key? key, this.adminID, this.adminName}) : super(key: key);

  @override
  _customChat createState() => _customChat(adminID, adminName);
}
...
class _customChat extends State<customChat> {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CupertinoButton(
                        ...
                        onPressed: () =>
                            pickImage(context, currentUserId, adminName),
                      ),
                      CupertinoButton(
  ...
  Future savingImageToStorage(File imageFile) async {
    ...
    await taskSnapshot.ref.getDownloadURL().then((url) {
      imageUrl = url;
      savingImageToDatabase(imageUrl, currentUserId, adminName);
      Navigator.pop(context);
    });
  }
}
